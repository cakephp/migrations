...
> [!NOTE]
> The <span class="title-ref">removeColumn</span> command is not reversible, so must be called in the
> <span class="title-ref">up</span> method. A corresponding <span class="title-ref">addColumn</span> call should be added to the
> <span class="title-ref">down</span> method.

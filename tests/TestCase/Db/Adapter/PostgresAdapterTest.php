...
class PostgresAdapterTest extends TestCase
{
    ...
    public function testDumpCreateTable()
    {
        ...
        if ($this->usingPostgres10()) {
            $expectedOutput = 'CREATE TABLE "public"."table1" ("id" SERIAL NOT NULL GENERATED BY DEFAULT AS IDENTITY, ' .
    ...
    public function testDumpCreateTableWithSchema()
    {
        ...
        if ($this->usingPostgres10()) {
            $expectedOutput = 'CREATE TABLE "schema1"."table1" ("id" SERIAL NOT NULL GENERATED BY DEFAULT AS IDENTITY, "column1" VARCHAR DEFAULT NULL, ' .
